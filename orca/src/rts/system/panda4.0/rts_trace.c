...
trc_event_t proc_create, proc_exit, obj_create, obj_destroy, op_descr,
	    ...
	    man_change, objtype_descr, cont_create, cont_done, pure_write;
...
{
    (void) trc_set_level(trace_level);
     ...
     */
    op_cont = trc_new_event( LEVEL-1, sizeof(op_inv_info),
...
*/
    ...
    pure_write = trc_new_event(6500, sizeof(op_inv_info),
			       "pure_write", "op = %h, obj = %h.%p");
}
