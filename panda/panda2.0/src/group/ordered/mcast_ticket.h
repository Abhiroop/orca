...
short int  msg_list_get(msg_list_p lst, pan_msg_p msg);

short int  msg_list_x_get(msg_list_p lst, pan_msg_p msg);

pan_msg_p  msg_list_put(msg_list_p lst, short int ticket);

pan_msg_p  msg_list_locate(msg_list_p lst, short int ticket);

void       msg_list_x_wait(msg_list_p lst, short int ticket);

void       msg_list_signal(msg_list_p lst, short int ticket);
