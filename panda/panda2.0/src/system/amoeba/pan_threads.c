...
pan_thread_join(pan_thread_p thread)
{
    ...
    /*
     * Bug fix: these statements should be in this order and not the
     * other way round, or else pan_thread_join frees the glocal data
     * that this thread will try to access (thread->join).
     */
