...
static pc_timer_type *pan_sys_mapped_timer;
...
amoeba_gettime(pan_time_p now)
{
    ...
    /* copy_timer(pan_sys_mapped_timer, (union sun4m_timer *)now); */

    *(union sun4m_timer*)now = *pan_sys_mapped_timer;
}
...
pan_sys_time_start(void)
{
    ...
    pan_sys_mapped_timer = &mapped_timer_struct->pc_timer;
