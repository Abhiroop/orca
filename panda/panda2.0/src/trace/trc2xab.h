...
/* Function prototypes for conversion of panda trace format to xab format.
 *
 * Author: Rutger Hofman, VU Amsterdam, november 1993.
 */

#ifndef _TRACE_TRC2XAB_H
#define _TRACE_TRC2XAB_H
...
extern void xab_fmt_printf(FILE *s, trc_p state);
