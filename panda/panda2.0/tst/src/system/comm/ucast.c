...
/*
 * ucast_pingpong:	test sending and receiving of unicast msgs by
...
rcve_frag(pan_fragment_p frgm)
{
    ...
    is_last = (pan_fragment_flags(frgm) & PAN_FRAGMENT_LAST);
    pan_msg_assemble(catch, frgm, 0);
...
static void
do_ucast(int msg_size, int nr_unicasts)
{
    int            i;
    pan_msg_p      msg;
    pan_fragment_p frgm;
